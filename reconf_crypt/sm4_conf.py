...
sm4_conf.layer_conf[0].pe_conf[3].r0_calc.src = b8(3)
    #connect
sm4_conf.layer_conf[0].conc_conf.conf_io.from_io = [0 for i in range(ROW_LEN)]
...
sm4_conf.layer_conf[1].pe_conf[1].r0_calc.src = b8(7)
    #connect
sm4_conf.layer_conf[1].conc_conf.conf_io.from_io =  [0 for i in range(ROW_LEN)]
...
sm4_conf.layer_conf[2].pe_conf[1].r0_calc.src = b8(1)
    #connect
sm4_conf.layer_conf[2].conc_conf.conf_io.from_io =  [0 for i in range(ROW_LEN)]
...
sm4_conf.layer_conf[3].pe_conf[3].imm = b32(0x12)
    #connect
sm4_conf.layer_conf[3].conc_conf.conf_io.from_io =  [0 for i in range(ROW_LEN)]
